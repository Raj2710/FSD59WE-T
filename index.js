...
// For Each is used only for iteration purpose
// let data = products.forEach((e)=>{
//     console.log(e.title)
//     return e.title
// })
...
//Map
// let data = products.map((e,i)=>{
//     console.log(e.title)
//     return `${i}: The product ${e.title} costs $${e.price}`
// })

// console.log(data)

//Filter
//Filter the products whose price are less than 500
// let filteredData = products.filter((e)=>e.price<500)
// console.log(filteredData)

// let data = products.filter((e)=>{
//     let discountedPrice = e.price * ((100-e.discountPercentage)/100)
...
// let data = products.filter((e)=>e.rating>4.5)
// console.log(data)
...
// let b = [100,200,300]
// a.push(10)//add an element at the end of array
// a.push(20,30,40)
// a.push(...b)
// a.pop()// delete the last element in the array

// a.unshift(...b)// insert element at the begining of array
// a.shift()//delete element at the begining

//slice - always gives you a new array and never modify the actual array
//slice(start) - provide the new array from the start Index
//slice(start,stop) - provide the new array between start and stop index
// let output = a.slice(2,7)
...
// a.splice(3,3)
// a.splice(3,1,40)
// a.splice(3,1,40,30,50)//1,2,3,40,30,50,5,6,7,8,9
// a.splice(3,0,40,30,50)//1,2,3,40,30,50,4,5,6,7,8,9
// console.log(a)

//sort()
// let a = ["hello","hai","welcome","to","guvi"]
// let a = [10,50,100,120,20,40,31,30]
